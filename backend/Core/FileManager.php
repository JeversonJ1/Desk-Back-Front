...
class FileManager{
    ...
    public function salvarArquivo(array $file,string $subDiretorio,array $tiposPermitidos = ['image/jpeg', 'image/png', 'application/pdf', 'image/webp'],int $tamanhoMaximo = 104857600) {
