<style>
    ...
    .btn-add-cat:hover {
        ...
        box-shadow: 0 8px 25px rgba(197, 160, 45, 0.3);
...
<div class="cat-wrapper">
                    ...
                    <?php foreach ($categorias as $categoria): ?>
                        <tr class="cat-row">
                            <td style="font-family: monospace; font-weight: 700; color: var(--text-muted);">
                                #<?= str_pad($categoria['id_categorias'], 3, '0', STR_PAD_LEFT) ?></td>
                            <td style="font-weight: 800;"><?= htmlspecialchars($categoria['nome_categorias']) ?></td>
                            <td style="color: var(--text-muted); font-size: 0.9em;">
                                <?= htmlspecialchars($categoria['descricao_categorias'] ?: 'Sem descrição informada') ?></td>
                            <td>
                            ...
                            <td>
                                <div class="action-btns" style="justify-content: center;">
                                    <a href="/backend/categoria/editar/<?= htmlspecialchars($categoria['id_categorias']) ?>"
                                        class="btn-edit-cat" title="Editar"><i class="fa fa-edit"></i></a>
                                    <a href="/backend/categoria/excluir/<?= htmlspecialchars($categoria['id_categorias']) ?>"
                                        class="btn-del-cat" title="Excluir"><i class="fa fa-trash"></i></a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
    ...
    <?php else: ?>
        <div
            style="background: var(--bg-card); border: 2px dashed var(--border-color); padding: 60px; text-align: center; border-radius: 16px;">
            <i class="fa fa-search"
                style="font-size: 3em; color: var(--text-muted); margin-bottom: 20px; display: block;"></i>
            ...
            <a href="/backend/categoria/criar"
                style="color: var(--accent); font-weight: 800; text-decoration: none; margin-top: 15px; display: inline-block;">Clique
                aqui para criar a primeira</a>
        </div>
    <?php endif; ?>
</div>
